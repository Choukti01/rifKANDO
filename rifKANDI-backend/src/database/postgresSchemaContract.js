...
const REQUIRED_MINOR_UNIT_COLUMNS = Object.freeze([
  ...
  ['orders', 'total_minor'],
  ['cod_fulfillments', 'gross_amount_minor'],
  ['cod_fulfillments', 'customer_delivery_fee_minor'],
  ['cod_fulfillments', 'expected_cod_amount_minor'],
  ['cod_fulfillments', 'commission_minor'],
  ['cod_fulfillments', 'seller_amount_minor'],
