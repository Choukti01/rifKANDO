  ...
  return (
    <div className="dashboard-container">
      ...
      <div className={`dashboard-sidebar ${isSidebarOpen ? 'open' : 'closed'} ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
        ...
        {/* Sidebar User - fixed, never scrolls */}
        ...
        {/* Sidebar Footer - fixed, never scrolls */}
      ...
      <style>{`
        ...
        .dashboard-sidebar {
          ...
          overflow: hidden; /* children control their own overflow */
        }
        .dashboard-sidebar.open  { width: 280px; }
        .dashboard-sidebar.closed { width: 80px; }

        /* ─── Scrollable nav area (the key fix) ─── */
        .sidebar-scroll-area {
          flex: 1;
          overflow-y: auto;
          overflow-x: hidden;
        ...
        .sidebar-scroll-area:hover::-webkit-scrollbar-thumb { background: #d1d5db; }
        ...
        @media (max-width: 768px) {
          ...
          .dashboard-sidebar.closed { width: 280px !important; }
          .mobile-dashboard-header { display: flex; }
          .dashboard-header.desktop-only { display: none; }
          .dashboard-main {
          ...
          .mobile-close-btn .icon { width: 1.25rem; height: 1.25rem; }
        }
        ...
        .sidebar-logo-text { font-weight: bold; font-size: 1.1rem; }
        ...
        .sidebar-user-info h4 { font-size: 0.875rem; margin-bottom: 0.25rem; }
        .sidebar-user-info p { font-size: 0.75rem; color: #6b7280; }
        ...
        .sidebar-nav-link.active { background: #87CEEB; color: #1a1a1a; }
        .sidebar-nav-icon { width: 1.25rem; height: 1.25rem; flex-shrink: 0; }
        ...
        .dashboard-main {
          ...
          padding: 1.5rem;
          /* Content scrolls independently — this is the default block scroll */
          min-width: 0; /* prevent flex overflow */
        }
        .dashboard-main.with-sidebar   { margin-left: 280px; }
        .dashboard-main.without-sidebar { margin-left: 80px; }
